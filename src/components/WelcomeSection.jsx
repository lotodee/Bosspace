...
const WelcomeSection = () => {
  ...
  return (
    <section className="h-[40vh] flex flex-col items-center justify-center space-y-6 px-4 bg-[url('https://th.bing.com/th/id/R.a5959263ff129b7bf1c7b578106ef56d?rik=tmn2bH7HecMXKQ&riu=http%3a%2f%2fwww.pixelstalk.net%2fwp-content%2fuploads%2f2016%2f07%2fPicture-Plain-HD.jpg&ehk=xQvEklueZmmJuRuwL6YghOZRB6twsklP1vfIAqpRTAs%3d&risl=&pid=ImgRaw&r=0')] bg-cover bg-center">
      ...
      {/* Input Section */}
      <div className="flex items-center w-full md:w-[80%] lg:w-[90%] bg-white shadow-lg border-2 border-gray-300  transition-all rounded-full">
      ...
      <div className="flex flex-wrap justify-center items-center ml-6 space-x-4 md:space-x-6 text-[#09153D]">
